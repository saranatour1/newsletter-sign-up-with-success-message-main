...
<template>
  ...
  <div v-if="!isValid"  class=' bg-white max-h-full w-full mx-auto my-0'>

    <div class=" h-72 m-0">
      <img src="/src/assets/illustration-sign-up-mobile.svg" class="h-full object-contain"/>
    </div>
...
>
  <div class="container">
    ...
    <p>
  A confirmation email has been sent to <span class=" font-extrabold">{{ emailVal }}</span> . 
